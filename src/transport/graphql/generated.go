...
//go:embed "schemas/auth.graphqls" "schemas/schema.graphqls"
...
func (ec *executionContext) _Mutation_login(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTokenPair2ᚖgithubᚗcomᚋgminetomaᚋgoᚑauthᚋsrcᚋtransportᚋgraphqlᚐTokenPair,
		true,
		true,
	)
}
...
func (ec *executionContext) _TokenPair_accessToken(ctx context.Context, field graphql.CollectedField, obj *TokenPair) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) _TokenPair_refreshToken(ctx context.Context, field graphql.CollectedField, obj *TokenPair) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) marshalNTokenPair2githubᚗcomᚋgminetomaᚋgoᚑauthᚋsrcᚋtransportᚋgraphqlᚐTokenPair(ctx context.Context, sel ast.SelectionSet, v TokenPair) graphql.Marshaler {
	return ec._TokenPair(ctx, sel, &v)
}

func (ec *executionContext) marshalNTokenPair2ᚖgithubᚗcomᚋgminetomaᚋgoᚑauthᚋsrcᚋtransportᚋgraphqlᚐTokenPair(ctx context.Context, sel ast.SelectionSet, v *TokenPair) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
